...
RSC-embedded rates + supermarket card hub HTML.
...
Research staged in [ArdenoStudio/lankawa](https://github.com/ArdenoStudio/lankawa) `api-docs/packages/dfcc-rates-docs/`. Source docs:
...
- Python: [`python/`](./python/) — `dfcc-rates-docs-unofficial` (`pip install -e .`)
