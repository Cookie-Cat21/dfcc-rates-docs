"""Minimal unofficial HTTP client for DFCC Rates & Card Offers.
...
DEFAULT_UA = "dfcc-rates-docs-unofficial/0.1 (+https://github.com/Cookie-Cat21/dfcc-rates-docs; educational; polite)"
DEFAULT_BASE = "https://www.dfcc.lk"


class DfccRatesDocsClient:
    """Unofficial client — DFCC Rates & Card Offers."""
    ...
    def __enter__(self) -> "DfccRatesDocsClient":
        return self
    ...
    def interest_rates_page(self, **kwargs: Any) -> Any:
    ...
    def exchange_rates_page(self, **kwargs: Any) -> Any:
        """FX rates page.
    ...
    def card_offers_supermarket(self, **kwargs: Any) -> Any:
